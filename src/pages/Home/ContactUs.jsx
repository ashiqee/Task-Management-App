...
const ContactUs = () => {
    return (
        <div>
            ...
            <div className="relative flex items-top justify-center   bg-transparent py-20 sm:items-center sm:pt-0">
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div className="mt-8 overflow-hidden">
                        <div className="grid grid-cols-1 justify-around gap-5 md:grid-cols-2">
                            <BgShadow>
                                <div className="p-8 mr-2 bg-gray-100 mt-10 dark:bg-gray-800 sm:rounded-lg">
