                                ...
                                <form className="p-4 md:p-5">
                                    <div className="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div className="col-span-2 sm:col-span-1">
                                            ...
                                            <input type="date" name="taskDeadLine" id="taskDeadLine" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="$2999" required="" />
                                        </div>
                                        <div className="col-span-2 sm:col-span-1">
                                            <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Task Priority</label>

                                            <select id="taskPriotity" value={taskPriotity} onChange={(e) => setTaskPriority(e.target.value)}>
